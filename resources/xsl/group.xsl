		...
		<form action="/QPDefender/app/group/groups/add" method="post" name="AddUpdateGroup">
			<div class="group_info">
					...
					<table width="539" border="0" class="productSpecs">
					  ...
					  <tr>
					    <td><a href="#" onclick="addUser(this)"><img src="/QPDefender/app/none/resources/media/img/add.png" alt="" width="18" height="18" border="0" align="absmiddle" /></a><a href="#"> Add Product</a></td>
					    <td>&#160;</td>
					    <td>&#160;</td>
					    <td>&#160;</td>
					  </tr>
